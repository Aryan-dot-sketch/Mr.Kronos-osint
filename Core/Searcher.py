...
class MrKronos:
    ...
    def search(username, Mode):
        try:
            ...
            choice = int(input(
                Font.Color.BLUE + "\n[+]" + Font.Color.WHITE + Language.Translation.Translate_Language(filename, "Default", "choice", "None") + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
            if choice == 1:
                http_proxy = Proxies.proxy.final_proxis
                http_proxy2 = Proxies.proxy.choice3
                source = "http://ip-api.com/json/" + http_proxy2
            ...
            if opt == 1:
                ...
                MrKronos.Scraping(report,username,http_proxy,InstagramParams,PostLocations, PostGpsCoordinates,TwitterParams)
            ...
            Recaps = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                    filename, "Default", "Hypo", "None") + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
            if Recaps == 1:
                if opt == 1:
            ...
            if count == 1:
                ...
                if choice == 1:
                    MrKronos.Google_dork(username)
                    MrKronos.Yandex_dork(username)
            ...
            print(Font.Color.RED + "[!]" + Font.Color.WHITE + " SEARCH ERROR: {}".format(str(e)))
            import traceback
            traceback.print_exc()
