...
class Menu:
    ...
    def Main(username,Mode):
        ...
        folder = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Transfer", "Folder", "None").format(Font.Color.GREEN + username + Font.Color.WHITE)  + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
        if folder == 1:
            fold = "Usernames"
            secondFold = "True"
        elif folder == 2:
            ...
            kronos.Main.Menu(Mode)
        if folder == 1 or folder == 4:
            choice = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Type", "None").format(username)  + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
        ...
        if secondFold != "Exception":
            option = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Transfer", "Type", "None") + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
            if option == 1:
                report = Report + ".txt"
                extension = ".txt"
                name = name2
