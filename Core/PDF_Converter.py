...
class Menu:
    ...
    def CreateTemplate(Template,Content,filename,htmlcontent,username):
        ...
        <body>
         <p>PDF REPORT FOR {} GRAPH</p>
          <div class = "Metadata">
            ...
            <p>PDF GENERATED BY MR.KRONOS</p>
            <p>GENERATED ON: {}</p>
            <p>MR.KRONOS DOWNLOAD LINK: https://github.com/aryanhubhaimai/Mr.Kronos-OSINT</p>
           </div>
            <br>
            {}
        </body>
        ...
        choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(langfile, "Transfer", "Question", "None") + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
