...
class Menu:
    ...
    def Main(username,Mode):
        ...
        folder = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Folder", "None").format(Font.Color.GREEN + username + Font.Color.WHITE)  + Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
        if folder == 1:
            fold = "Usernames"
            secondFold = "True"
        elif folder == 2:
        ...
        option = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                        filename, "Decoding", "Options", "None")+ Font.Color.GREEN + "[#MR.KRONOS#]" + Font.Color.WHITE + "-->"))
        if option == 1:
            report = Report + ".txt" 
