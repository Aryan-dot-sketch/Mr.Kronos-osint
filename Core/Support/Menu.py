...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN + text
              +
              Font.Color.WHITE + "| A COMPLETE OSINT TOOL:)      " + Font.Color.BANNER + "CODED BY ARYAN" + Font.Color.RESET + Font.Color.WHITE + "                      |\n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "    |")
        print(
            Font.Color.YELLOW + "|                                                                   |\n|" + Font.Color.WHITE + "\t\t\t    MADE IN INDIA 🇮🇳\t\t\t    " + Font.Color.YELLOW + "|\n|" + Font.Color.WHITE + "\t\t\t  CODED BY ARYAN\t\t\t    " + Font.Color.YELLOW + "|\n|                                                                   |")
        print(Font.Color.WHITE +
              "---------------------------------------------------------------------")
    ...
    def Mobile_Banner():
        ...
        print(Font.Color.WHITE + "A COMPLETE OSINT TOOL:)      " +
              Font.Color.BANNER + "CODED BY ARYAN" + Font.Color.RESET)
        print(Font.Color.WHITE + "\n[+]" +
        ...
        while True:
            try:
                ...
                if (sce == 1):
                    ...
                    Searcher.MrKronos.search(username, Mode)
